...
# MultiSafepay plugin 2.0 for Magento 2 (Catalog Inventory-only) **(Beta)**

This is a beta version of the Catalog Inventory stock handling module of our new Magento 2 plugin. 
...
```bash
bin/magento module:enable MultiSafepay_ConnectCatalogInventory
```
